...
hold off
title('Plot of interest rate and price index, c=0.5','FontSize',16)
...
hold off
title('Plot of interest rate and investment demand, c=0.5','FontSize',16)
xlabel('Interest Rate, r','FontSize',14)
...
title('Plot of Investment Demand and Price Index, c=0.5','FontSize',16)
xlabel('Investment Demand, d','FontSize',14)
ylabel('Price Index, p','FontSize',14)

nexttile
plot(t,X(:,1))
title('Plot of Interest Rate Over Time, c=0.5','FontSize',16)
xlabel('t(months)','FontSize',14)
ylabel('Interest Rate, r','FontSize',14);
nexttile 

plot(t,X(:,2))
title('Plot of Investment Demand Over Time, c=0.5','FontSize',16)
xlabel('t(months)','FontSize',14)
ylabel('Investment Demand, d','FontSize',14);
nexttile 

plot(t,X(:,3))
title('Plot of Price Index Over Time, c=0.5','FontSize',16)
xlabel('t(months)','FontSize',14)
ylabel('Price Index, p','FontSize',14)
