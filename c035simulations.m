...
%system using a c value of 0.35 and the proper initial condition

%Creates the system of equations, note using 0.35 as the c value
...
hold off
title('Plot of interest rate and price index, c=0.35','FontSize',16)
...
hold off
title('Plot of interest rate and investment demand, c=0.35','FontSize',16)
xlabel('Interest Rate, r','FontSize',14)
...
title('Plot of Investment Demand and Price Index, c=0.35','FontSize',16)
...
hold off
title('Plot of interest rate, investment demand, and price index, c=0.35','FontSize',16)
xlabel('Interest Rate, r','FontSize',14)
